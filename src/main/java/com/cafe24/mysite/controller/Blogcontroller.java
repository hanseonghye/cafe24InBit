...
import com.cafe24.mysite.vo.BlogVo;
import com.cafe24.mysite.vo.CategoryVo;
import com.cafe24.mysite.vo.PostVo;
...
public class Blogcontroller {
	...
	@RequestMapping(value = { "/{id}", "/{id}/{category}", "/{id}/{category}/{post}" }, method = RequestMethod.GET)
	...
	public String adminWrite(@PathVariable(value = "id") String blog_id, @ModelAttribute PostVo vo,
	...
	@ResponseBody
	@RequestMapping(value = { "{id}/admin/delete/{category}" }, method = RequestMethod.POST)
